...
TEST(set, ConstructorCopySet) {
  hegel::set<int> my_set = {1, 2, 3, 4, 5};
  std::set<int> orig_set = {1, 2, 3, 4, 5};
  hegel::set<int> my_set_copy = my_set;
...
TEST(set, ConstructorMoveSet) {
  hegel::set<int> my_set = {1, 2, 3, 4, 5};
  std::set<int> orig_set = {1, 2, 3, 4, 5};
  hegel::set<int> my_set_copy = std::move(my_set);
...
TEST(set, SetIteratorsSet) {
  hegel::set<std::string> my_set = {"This", "is", "my", "set"};
...
TEST(set, EraseSet) {
  hegel::set<int> my_set = {5, 4, 3, 2, 7, 8, 9};
...
TEST(set, SwapSet) {
  hegel::set<int> my_set = {1};
  hegel::set<int> my_swap_set = {3, 4, 5};
...
TEST(set, MergeSet) {
  hegel::set<int> my_set = {1};
  hegel::set<int> my_merge_set = {3, 4, 5};
...
TEST(set, FindSet) {
  hegel::set<double> my_set = {2.1, 2.2, 2.3, 2.4, 2.5, 2.6};
  hegel::set<double> orig_set = {2.1, 2.2, 2.3, 2.4, 2.5, 2.6};
