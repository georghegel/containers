...
By constraining the way nodes can be colored on any path from the root to a leaf, red-black trees ensure that no such path <br>
is more than twice as long as any other, so that the tree is approximately balanced.<br>
